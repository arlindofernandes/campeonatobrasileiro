...
public class JogoRestController {
 ...
 public ResponseEntity<JogoDTO> finalizar(@PathVariable Integer id, @RequestBody JogoFinalizadoDTO dto ) throws Exception{
        return ResponseEntity.ok().body(jogoService.finalizarJogo(id ,dto));
    }

//     @GetMapping(value = "/classificacao")
//  public ResponseEntity<JogoDTO> classificacao(@PathVariable Integer id ){
//         return ResponseEntity.ok().body(jogoService.obterClassificacao(id));
//     }
